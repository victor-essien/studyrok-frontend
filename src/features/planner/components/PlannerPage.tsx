                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow p-6">
                      ...
                      <div className="flex items-center justify-between mb-6">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          >
                            <ChevronLeft className="w-5 h-5 dark:text-gray-200 text-gray-800" />
                          </button>
                          <button
                            onClick={() => {
                          ...
                          <button
                            ...
                            className="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition"
                          >
                            <ChevronRight className="w-5 h-5 dark:text-gray-200 text-gray-800" />
                          </button>
                        </div>
                      </div>
                          ...
                          {selectedDateSessions.map((session) => (
                            ...
                            >
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                >
                                  <Trash2 className="w-4 h-4 text-red-600 dark:text-red-200" />
                                </button>
                              </div>
                            </motion.div>
                          ))}
                        ...
                        .map((session) => (
                          <motion.div
                            ...
                            className={`p-6 rounded-2xl border-2 flex items-center gap-4 ${
                              session.completed
                                ? 'bg-green-50 border-green-200'
                                : 'bg-white dark:bg-gray-800 dark:border-gray-700 border-gray-200'
                            }`}
                          >
                            <div
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <button
                                onClick={() => handleEditSession(session)}
                                className="p-2 hover:bg-gray-100 dark:text-gray-400 rounded-lg transition"
                              >
              ...
              {showNewSessionModal && (
                ...
                >
                  <motion.div
                    ...
                    className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-6 md:p-8 w-full max-w-2xl max-h-[90vh] overflow-y-auto"
                  >
                    <div className="flex items-center justify-between mb-6">
                      ...
                      <button
                        onClick={() => setShowNewSessionModal(false)}
                        className="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-800 dark:text-gray-100 rounded-lg transition"
                      >
                        <X className="w-6 h-6" />
                      </button>
                    </div>
                    ...
                    <div className="space-y-6">
                            ...
                            <button
                              ...
                              className={`p-4 rounded-xl border-2 transition ${
                                formData.boardId === board.id
                                  ...
                                  : 'border-gray-200 dark:border-gray-600 dark:hover:border-purple-400 hover:border-purple-300 '
                              }`}
                              style={{
                                backgroundColor:
                                  formData.boardId === board.id
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-4 py-3 bg-white text-gray-800 dark:text-white dark:bg-gray-700 rounded-xl border-2 dark:border-gray-600 border-gray-200 focus:border-purple-600 focus:ring-2 focus:ring-purple-200 outline-none transition"
                          />
                        </div>
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-4 py-3 rounded-xl border-2  text-gray-800 dark:text-white dark:bg-gray-700 dark:border-gray-600 border-gray-200 focus:border-purple-600 focus:ring-2 focus:ring-purple-200 outline-none transition"
                          />
                        </div>
                      </div>
                      ...
                      <div>
                        <label className="flex items-center gap-3 cursor-pointer">
                          <input
                            ...
                            className="w-5 h-5 rounded dark:border-gray-300 border-gray-300 text-purple-600 focus:ring-purple-500"
                          />
                          <div>
                        ...
                        {formData.reminder && (
                          <div className="mt-4">
                            ...
                            <select
                              ...
                              className="w-full px-4 py-3 rounded-xl border-2  text-gray-800 dark:text-white dark:bg-gray-700  border-gray-200 dark:border-gray-700 focus:border-purple-600 focus:ring-2 focus:ring-purple-200 outline-none transition"
                            >
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="w-full px-4 py-3 rounded-xl  text-gray-800 dark:text-white dark:bg-gray-700  border-2 border-gray-200 dark:border-gray-700 focus:border-purple-600 focus:ring-2 focus:ring-purple-200 outline-none transition"
                        >
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          className="w-full px-4 py-3 rounded-xl border-2 border-gray-200  text-gray-800 dark:text-white dark:bg-gray-700  dark:border-gray-700 focus:border-purple-600 focus:ring-2 focus:ring-purple-200 outline-none resize-none transition"
                        />
                      </div>
                      ...
                      <div className="flex gap-4 pt-4">
                        <button
                          onClick={() => setShowNewSessionModal(false)}
                          className="flex-1 px-6 py-3 border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-white rounded-xl font-semibold hover:bg-gray-50 transition"
                        >
                          Cancel
                        </button>
                        <button
